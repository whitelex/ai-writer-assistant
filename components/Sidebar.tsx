...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div className={`
        fixed md:relative z-50 md:z-0 w-72 h-full border-r bg-slate-900 flex flex-col text-slate-300 transition-transform duration-300 ease-in-out
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/50">
          ...
          <div className="flex items-center justify-center">
            <div className={`flex items-center gap-1.5 px-2 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest ${
              ...
              {storageMode === 'real' ? 'Cloud Sync' : 'Offline'}
            </div>
          </div>
        </div>
      </div>
